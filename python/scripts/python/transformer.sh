...
--train_sub train/code.${CODE_EXTENSION} \
--train_ky train/code.${INTOKEN} \
--train_it train/code.${INTOKEN} \
--train_is train/code.${INSTATEMENT} \
--train_df train/dataflow_subtoken_v3.npy \
--train_cf train/dataflow_subtoken_v3.npy \
--train_tgt train/javadoc.${JAVADOC_EXTENSION} \
--dev_src test/code.${CODE_EXTENSION} \
--dev_sub test/code.${CODE_EXTENSION} \
--dev_ky test/code.${INTOKEN}  \
--dev_it test/code.${INTOKEN} \
--dev_is test/code.${INSTATEMENT} \
--dev_df test/dataflow_subtoken_v3.npy \
--dev_cf test/dataflow_subtoken_v3.npy \
...
--dev_it test/code.${INTOKEN} \
--dev_is test/code.${INSTATEMENT} \
--dev_df test/data_flow.npy \
--dev_cf test/data_flow.npy \
--dev_tgt test/javadoc.${JAVADOC_EXTENSION} \
--uncase True \
--max_examples -1 \
--max_src_len 150 \
